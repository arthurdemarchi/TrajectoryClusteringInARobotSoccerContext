...
FieldAnalyzer: Análise para dados de correspondência 2d
...
class FieldAnalyzer(object):
    ...
    def ballPos(self, cycle):
        ...
        :param cycle:
        :return: 返回该周期球的x、y坐标
        : return: Retorna as coordenadas x, y da bola do período
        """
    ...
    def isBallOutside(self, cycle):
        """
        判断该周期球是否出界
        Determine se a bola periódica está fora dos limites
        :param cycle:
        :return:
        """
        ...
        if ball_x >= 52.5 or ball_x <= -52.5 or ball_y >= 34.0 or ball_y <= -34.0:
            ...
            return True
        elif math.fabs(ball_x) == 47.0 and math.fabs(ball_y) == 9.0:    # TODO: 待确认 - TODO: Para ser confirmado
            return True
        else:
            return False
    ...
    def getDistNearestTo(self, data, with_goalie, point):
        ...
        : param cycle_data: dados para o período especificado
        :param with_goalie: 是否包含守门员
        : param with_goalie: Inclui o goleiro?
        :param point: 指定的点，点的x和y坐标组成的数组
        : ponto de parametro: o ponto especificado, uma matriz de pontos x e y coordenadas
        :return: 最近的距离
        : retorno: a distância mais próxima
        """
    ...
    def lastKickerSide(self, cycle):
        ...
        : return: Retorna o período do chute e o nome da equipe antes do ciclo
        """
        """
        TODO:
            怎么过滤掉无效kick的数据？
            Como filtrar dados de kick inválidos?
        """
    ...
    def nextKickerSide(self, cycle):
        ...
        : return: Retorna o período do chute e o nome da equipe após o período
        """
        """
        TODO:
            怎么过滤掉无效kick的数据？
...
if __name__ == '__main__':
    data = pd.read_csv('../csv/20180621130004-CYRUS2018_0-vs-HELIOS2018_1.csv')
